...
VALUES
    ...
    ('ZFYYMZ29E6', 'Nebula Glass Star Atlas', 'A comprehensive full-color star atlas featuring over 30,000 objects across 88 constellation charts, with limiting magnitude 9.5. Perfect for planning observing sessions at the eyepiece or imaging runs. Printed on durable, lay-flat pages for easy use at the telescope in the dark.', 'NebulaGlassStarAtlas.jpg', 'USD', 34, 950000000, 'books,accessories');