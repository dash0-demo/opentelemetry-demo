...
VALUES
    ...
    ('ZFYYMZ29E6', 'Sky Map Star Chart', 'A detailed planisphere star chart covering the full night sky visible from mid-northern latitudes. Rotate the wheel to match any date and time and see exactly which constellations, stars, and deep-sky objects are above your horizon. Printed on durable, weather-resistant card stock with a protective sleeve — an essential planning tool for every amateur astronomer.', 'SkyMapStarChart.jpg', 'USD', 19, 990000000, 'accessories,books');
