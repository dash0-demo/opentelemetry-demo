...
VALUES
    ...
    ('ZFYYMZ29E6', 'Sky Atlas 2000.0', 'The definitive visual sky atlas for the serious amateur astronomer. Sky Atlas 2000.0 covers the entire sky with 26 large-format charts plotting over 81,000 stars down to magnitude 8.5 and more than 2,700 deep-sky objects including nebulae, galaxies, and star clusters. An indispensable reference for both visual observing and astrophotography planning.', 'TheCometBook.jpg', 'USD', 34, 950000000, 'books,accessories');