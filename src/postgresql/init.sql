...
VALUES
    ...
    ('ZFYYMZ29E6', 'Skygazer Planisphere', 'A precision star chart and rotating planisphere for stargazers of all skill levels. Identify constellations, stars, and planets visible from any latitude. The durable, weather-resistant design makes it ideal for use outdoors at night.', 'SkygazerPlanisphere.jpg', 'USD', 29, 950000000, 'accessories,books');