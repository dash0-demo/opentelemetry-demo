...
VALUES
    ...
    ('ZFYYMZ29E6', 'Starsense Explorer Telescope', 'The Celestron StarSense Explorer LT 80AZ is a mid-range refractor telescope that uses your smartphone to analyse the night sky and automatically calculate its pointing position. Compatible with most iOS and Android devices, it is particularly suited for beginners who want guided celestial tours.', 'StarsenseExplorerLT80AZ.jpg', 'USD', 199, 950000000, 'telescopes');