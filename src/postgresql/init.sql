...
VALUES
    ...
    ('ZFYYMZ29E6', 'Star Adventurer 2i Pro Pack', 'The Star Adventurer 2i motorized mount is an ultra-portable, affordable tracking mount perfect for astrophotography. It tracks celestial objects to keep them centered in your frame for long exposure photography. Includes a ball head, polar scope, counterweight bar, and multi-adapter bracket.', 'StarAdventurer2iPack.jpg', 'USD', 399, 0, 'accessories,telescopes,mount'),
