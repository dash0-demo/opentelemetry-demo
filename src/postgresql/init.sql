...
VALUES
    ...
    ('ZFYYMZ29E6', 'Sky Explorer Refractor Telescope', 'A compact and portable refractor telescope ideal for beginner stargazers and travellers. Features a 70mm aperture and fully coated glass optics for clear views of the moon, planets, and brighter deep-sky objects. Includes two eyepieces and a lightweight aluminium tripod.', 'SkyExplorerRefractor.jpg', 'USD', 89, 950000000, 'telescopes');