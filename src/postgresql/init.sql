...
VALUES
    ...
    ('ZFYYMZ29E6', 'Astronomy Star Atlas', 'A comprehensive star atlas for amateur and experienced astronomers, featuring detailed star maps of all 88 constellations, deep-sky object charts for nebulae, star clusters and galaxies, and month-by-month seasonal sky guides. Printed on durable, lay-flat binding with night-vision-friendly red-tinted pages.', 'AstronomyStarAtlas.jpg', 'USD', 28, 990000000, 'books');