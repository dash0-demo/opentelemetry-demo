...
VALUES
    ...
    ('ZFYYMZ29E6', 'Astronomy Star Atlas', 'A comprehensive star atlas for amateur astronomers covering the entire sky with detailed charts of over 30,000 stars, 1,500 deep-sky objects, and month-by-month sky guides. Suitable for naked-eye, binocular, and telescope observing sessions alike.', 'AstronomyStarAtlas.jpg', 'USD', 39, 950000000, 'books,accessories');